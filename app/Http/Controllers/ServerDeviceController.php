...
class ServerDeviceController extends Controller
{
    ...
    {
        $query = ServerDevice::with(['status', 'deviceType', 'location', 'responsible', 'serverType']);
    ...
    {
        $device = ServerDevice::with(['status', 'deviceType', 'location', 'responsible', 'serverType'])->findOrFail($id);
    ...
    public function create(Request $request)
    {
        ...
        return response()->json($server->load(['status', 'deviceType', 'location', 'responsible', 'serverType']), 201);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return response()->json($server->load(['status', 'deviceType', 'location', 'responsible', 'serverType']));
    }
